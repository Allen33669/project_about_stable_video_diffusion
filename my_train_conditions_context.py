...
#only train lora, set frozen layer to requires_grad = False
...
#only train context embedder, set frozen layer to requires_grad = False
print(f'only train context embedder-----------------------------------')
for name, param in model.named_parameters():
  if "spatial_context_embedder" in name:
    print(f'parameter name: {name}, param.is_leaf: {param.is_leaf}')
  elif "temporal_context_embedder" in name:
    print(f'parameter name: {name}, param.is_leaf: {param.is_leaf}')
  else:
    if param.is_leaf:
      param.requires_grad = False
